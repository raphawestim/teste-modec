...
function doLMSInitialize() {
    ...
    if (api == null) {
        ...
        historyLog("Unable to locate the LMS's API Implementation.\nLMSInitialize was not successful.")
        return "false";
    }
...
function doLMSFinish(status) {
    ...
    if (api == null) {
        ...
        var result = api.LMSFinish(status);
        if (result.toString() != "true") {
            var err = ErrorHandler();
        }
...
function getAPI() {
    ...
    if ((theAPI == null) && (parent.window.opener) && (parent.window.opener != window)) {
        theAPI = findAPI(parent.window.opener)
    }

    if ((theAPI == null) && (window.parent) && (window.parent != window)) {
    ...
    if ((theAPI == null) && (window.parent.parent.opener != null) && (typeof (window.parent.parent.opener) != "undefined")) {
        theAPI = findAPI(window.parent.parent.opener);
    }

    if ((theAPI == null) && window.parent.opener != null) {
        if ((window.parent.opener.opener != null) && (typeof (window.parent.opener.opener) != "undefined")) {
            theAPI = findAPI(window.parent.opener.opener);
        }
    }
    if (theAPI == null) {
        //alert("Unable to find an API adapter");
        historyLog("Unable to find an API adapter")
    }
    return theAPI

}

function historyLog(p_strAlert) {
    var objLog = new Object();
    objLog.strAlert = p_strAlert;
    //objLog.error = ErrorHandler();
    arrLogs.push(objLog);
    //s console.log(arrLogs)
}
